  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <CustomButton onClick={handleAddDocument} className="primary-button-gradient text-white px-6 py-3 rounded-lg shadow-card-float transition-all duration-300"> {/* Use gradient and new shadow */}
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <CustomCard className="bg-red-50 border-l-4 border-red-400 p-4 rounded-r-lg shadow-card-float alert-expire"> {/* Use new card shadow */}
