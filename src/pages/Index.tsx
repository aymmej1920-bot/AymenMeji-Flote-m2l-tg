      ...
      >
        <CustomCard className="text-center p-8">
          <CustomCardContent className="p-0">
            <h1 className="text-5xl font-heading font-extrabold mb-4 text-foreground">Bienvenue sur Application de gestion Parc auto M2l-TG</h1> {/* Use text-foreground for theme support */}
