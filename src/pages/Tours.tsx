  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <CustomButton onClick={handleAddTour} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg professional-shadow transition-all duration-300">
